...
export default function VisualTableCanvas({
  ...
  return (
    <div className={`min-h-screen bg-gray-50 dark:bg-gray-900 ${isFullscreen ? 'fixed inset-0 z-50 bg-white dark:bg-gray-900' : ''}`}>
      {/* Header Controls */}
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-gray-900 dark:text-white">Live Dashboard</h1>
            </div>
        ...
        {isEditMode && !readOnly && (
          <div className="bg-blue-50 dark:bg-blue-900/20 border-t border-blue-200 dark:border-blue-800 px-4 py-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-sm font-medium text-blue-800 dark:text-blue-200">Edit Mode:</span>
                <div className="flex items-center gap-1 text-xs text-blue-600 dark:text-blue-400">
                  <Move className="w-3 h-3" />
                  <span>Drag tables to move</span>
                </div>
                <div className="w-px h-4 bg-blue-300 dark:bg-blue-600 mx-2" />
                <button className="flex items-center gap-1 px-2 py-1 bg-white dark:bg-gray-800 border border-blue-300 dark:border-blue-600 rounded text-xs text-blue-700 dark:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20">
              ...
              <button
                ...
                className="flex items-center gap-1 px-3 py-1 bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-300 border border-red-300 dark:border-red-600 rounded text-xs hover:bg-red-200 dark:hover:bg-red-900/40"
              >
                <X className="w-3 h-3" />
      ...
      <div className="flex h-[calc(100vh-140px)]">
        ...
        <div className="w-32 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-2 overflow-y-auto">
          <div className="flex items-center gap-1 mb-2">
            <Layers className="w-3 h-3 text-gray-600 dark:text-gray-400" />
            <div className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Zones</div>
          </div>
          <div className="space-y-1">
            <button
              ...
              className={`w-full text-left px-2 py-1 rounded text-xs font-medium transition-colors ${
                selectedZone === 'all'
                  ? 'bg-orange-100 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300 border border-orange-200 dark:border-orange-600'
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] bg-gray-100 dark:bg-gray-700 px-1 py-0.5 rounded">{tables.length}</span>
              </div>
            </button>
            {zones.slice(1).map(zone => {
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span>{zone}</span>
                    <span className="text-[10px] bg-gray-100 dark:bg-gray-700 px-1 py-0.5 rounded">{zoneTableCount}</span>
                  </div>
        ...
        <div className="flex-1 p-4">
          <div
            ref={canvasRef}
            className="relative bg-white dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 h-full overflow-hidden"
          ...
          >
            ...
            {selectedZone !== 'all' && (
              <div className="absolute top-2 left-2 bg-orange-100 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300 px-3 py-1 rounded-full text-xs font-semibold border border-orange-200 dark:border-orange-600">
                {selectedZone}
              </div>
            )}
            ...
            {filteredTables.length === 0 && (
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-sm">No tables found in {selectedZone}</p>
                  {!readOnly && (
                    <button
                      onClick={() => setIsAddingTable(true)}
        ...
        <div className={`${isDeliveryCollapsed ? 'w-16' : 'w-80'} bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300 flex flex-col`}>
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div className={`flex items-center gap-2 ${!isDeliveryCollapsed ? '' : 'flex-col gap-1'}`}>
                ...
                {!isDeliveryCollapsed && (
                  <>
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Delivery Queue</h2>
              ...
              >
                <ChevronDown className={`w-4 h-4 text-gray-500 dark:text-gray-400 transition-transform ${isDeliveryCollapsed ? 'rotate-180' : ''}`} />
              </button>
            </div>
          </div>
      ...
      {isAddingTable && !readOnly && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Add New Table</h3>

            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Table Code</label>
                <input
                  type="text"
      ...
      {showAutoLayoutDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Auto Layout Configuration</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Spacing (px)</label>
                <input
                  type="number"
                  min="50"
                  max="200"
