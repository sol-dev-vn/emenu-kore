...
import { Home, Settings, Table as TableIcon, Utensils, Megaphone, History, Building2, Users, Shield, MessageSquare, HelpCircle, User as UserIcon, LogOut, ChevronDown, X, CheckCircle, Sun, Moon, Monitor, Menu, ChevronLeft, Languages } from 'lucide-react';
...
export default function PortalLayout({ children }: { children: React.ReactNode }) {
  ...
  // locale is handled by next-intl routing
  ...
  async function handleBranchSelect(branchId: string) {
    try {
      ...
      // No server-side impersonation route needed
    } catch (e) {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50 dark:bg-gray-900 transition-colors" suppressHydrationWarning>
      {mounted && (
        <>
